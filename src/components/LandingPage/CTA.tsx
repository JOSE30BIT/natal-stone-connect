      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl mb-8 text-stone-light max-w-3xl mx-auto">
            Solicite seu orçamento agora no WhatsApp e receba atendimento personalizado
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
            ...
            <p className="text-stone-light">Segunda a Sexta: 8h às 18h</p>
            <p className="text-stone-light">Sábado: 8h às 12h</p>
          </div>
        </div>
